...
parser.add_argument('--train_root',type=str,default="/home/data/zd/datasets"
)
# Saving specifications
parser.add_argument('--outf', type=str, default='./exp/ours/midet_9_newnew', help='saving_path')
