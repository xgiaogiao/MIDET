...
parser.add_argument('--data_path', default='/home/data/SSROriData//TSA_real_data/Measurements/', type=str,help='path of data')
parser.add_argument('--mask_path', default='/home/data/SSROriData//TSA_real_data/mask.mat', type=str,help='path of mask')
...
parser.add_argument("--pretrained_model_path", default='/home/zd/exp/midet_1/2024_03_26_09_53_42/model_296.pth', type=str)
...
for j in range(5):
    ...
    save_path='/home/zd/exp/imgs/new_17/'
